...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-02-2024 a las 21:08:26
...
(110, 94, 35, '35', 127, '2024-02-01 15:01:19'),
(113, 94, 35, 'Managua', 128, '2024-02-01 15:31:26'),
(114, 94, 35, 'si', 129, '2024-02-01 15:31:26'),
(115, 92, 5, '[mavtH]', 125, '2024-02-01 16:40:52'),
(116, 92, 5, '[JCVLo]', 126, '2024-02-01 16:40:52'),
(117, 92, 5, '[mavtH]', 125, '2024-02-01 16:41:52'),
(118, 92, 5, '[JCVLo]', 126, '2024-02-01 16:41:52');
...
(125, 'Area', '{\"mavtH\":\"Informatica\",\"gybLj\":\"Rrhh\"}', 'check_opt', 0, 92, '2024-01-29 16:53:52'),
(126, 'Pais', '{\"JCVLo\":\"Nicaragua\",\"uPZeb\":\"Honduras\"}', 'check_opt', 0, 92, '2024-01-29 16:54:36'),
(127, 'Que edad tienes', '', 'textfield_s', 0, 94, '2024-02-01 14:50:33'),
(128, 'Donde Vives', '', 'textfield_s', 0, 94, '2024-02-01 14:50:43'),
(129, 'Viajas mucho', '', 'textfield_s', 0, 94, '2024-02-01 15:31:10');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `survey_asig`
--

CREATE TABLE `survey_asig` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `survey_asig`
--

INSERT INTO `survey_asig` (`id`, `id_survey`, `id_asig`) VALUES
(5, 13, 5),
(6, 25, 1),
(7, 13, 1),
(8, 13, 8),
...
(13, 'CAB - Ejemplo', 'Prueba 2024  - 2023', 0, '2023-06-05', '2023-06-23', '2023-06-03 02:48:09'),
...
(85, 'ENCUENTA DE EVALUACION DE COMPETENCIAS', 'pruebasdd', 0, '2023-11-12', '2025-11-30', '2023-11-17 21:31:15'),
...
(89, 'prueba', 'prueba', 0, '2024-01-17', '2024-01-31', '2024-01-17 14:44:53'),
(90, 'Encuenta 2024 - 2025', 'Prueba', 0, '2024-01-29', '2024-01-31', '2024-01-22 16:18:40'),
(91, 'prueba 2024 - 25 2023  asignar', 'prueba 2024 - 25 2023 asignar', 0, '2024-01-24', '2024-01-26', '2024-01-23 14:08:13'),
(92, 'Encuesta de autoevalucion', 'Pruebas', 0, '2024-01-24', '2024-01-31', '2024-01-29 16:45:22'),
(93, 'evalucaicion 2024', 'evalucaicion 2024', 0, '2024-02-01', '2024-02-28', '2024-01-29 16:45:27'),
(94, 'encuentas 2030', 'encuentas 2030', 0, '2024-02-01', '2024-02-04', '2024-02-01 14:38:54');
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `middlename`, `contact`, `address`, `email`, `password`, `type`, `date_created`, `area`, `puesto`, `pais`) VALUES
(1, 'Congfiguro ', 'Web', '', '', 'Colombia', 'hola@configuroweb.com', '4b67deeb9aba04a5b54632ad19934f26', 1, '2020-11-10 08:43:06', '', '', ''),
(5, 'Pedro', 'Encuesta', '', '3142341324', 'Calle 56 56 45', 'pencuesta@cweb.com', '4b67deeb9aba04a5b54632ad19934f26', 3, '2022-08-23 09:14:34', '', '', ''),
...
(14, 'admin', 'admin', 'admin', 'admin', 'admin', 'admin@admin.com', '4b67deeb9aba04a5b54632ad19934f26', 3, '2023-08-17 04:49:07', '', '', ''),
...
(35, 'Fredy', 'Paniagua', '', '', '', 'admin2024@admin.com', '4b67deeb9aba04a5b54632ad19934f26', 3, '2024-01-19 13:14:21', 'Informatica', 'Programador', 'NIcaragua'),
(36, 'Randy', 'Lopez', '', '', '', 'randy@gnail.com', 'e10adc3949ba59abbe56e057f20f883e', 3, '2024-01-22 16:17:03', 'Informatica', 'Programador', 'NIcaragua');
...
--
-- Indices de la tabla `survey_asig`
--
ALTER TABLE `survey_asig`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `survey_asig`
--
ALTER TABLE `survey_asig`
