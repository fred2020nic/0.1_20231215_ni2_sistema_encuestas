		...
		<div class="col-md-4">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<h3 class="card-title"><b>Información de Encuesta</b></h3>
				...
				<div class="card-body p-0 py-2">
					<div class="container-fluid">
						...
						<p>Final: <b><?php echo date("M d, Y", strtotime($end_date)) ?></b></p>
						<p>Encuestas Tomadas: <b><?php echo number_format($taken) ?></b></p>
